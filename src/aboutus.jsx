      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        ...
        <div className="mt-20">
          ...
          <p className="mt-4 text-lg text-gray-500">
            At InsureCo, our mission is to provide peace of mind through comprehensive insurance solutions. We strive to be more than just an insurance provider – we aim to be a trusted partner in safeguarding your future. Our commitment to excellence, integrity, and customer satisfaction drives everything we do.
          </p>
        </div>
      </div>
    </div>
